...
function calculateTax( num_sales ,amount_tax ,net_sales ) {
  var num_sales ; 
  var amount_tax ; 
  var net_sales ;
  var tax ; 

  amount_tax=(num_sales* tax) ;
  net_sales=(num_sales - amount-tax) ;
  return " you got"+num_sales +"you shold pay "+ amount_tax + "and you will have "+ net_sales ; 
}
document.write( calculateTax(700 ,0.16 )) ; 
...
while (counter<n2){
return  "  " + str + "  " n2 ;  // 
/*I'm not find the property mehtod for count string and convert it to upper case !  
